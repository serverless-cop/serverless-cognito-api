...
// src/handler/todo-delete-handler.ts
var todo_delete_handler_exports = {};
__export(todo_delete_handler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(todo_delete_handler_exports);
...
// src/lib/error/ExternalError.ts
...
function getPathParameter(event, parameter) {
  const value = event.pathParameters ? event["pathParameters"][parameter] : void 0;
  if (!value) {
