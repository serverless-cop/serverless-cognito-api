...
// src/handler/todo-create-handler.ts
var todo_create_handler_exports = {};
__export(todo_create_handler_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(todo_create_handler_exports);
