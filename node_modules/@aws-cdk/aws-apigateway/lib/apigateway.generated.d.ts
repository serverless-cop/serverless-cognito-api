...
export interface CfnGatewayResponseProps {
    /**
     * The response type. For valid values, see [GatewayResponse](https://docs.aws.amazon.com/apigateway/latest/api/API_GatewayResponse.html) in the *API Gateway API Reference* .
     *
...
export declare namespace CfnMethod {
    ...
    interface IntegrationProperty {
        ...
        /**
         * The type of backend that your method is running, such as `HTTP` or `MOCK` . For all of the valid values, see the [type](https://docs.aws.amazon.com/apigateway/latest/api/API_Integration.html#type) property for the `Integration` resource in the *Amazon API Gateway REST API Reference* .
         *
...
export declare namespace CfnStage {
    ...
    interface MethodSettingProperty {
        ...
        readonly httpMethod?: string;
        /**
         * The logging level for this method. For valid values, see the `loggingLevel` property of the [Stage](https://docs.aws.amazon.com/apigateway/latest/api/API_MethodSetting.html#apigw-Type-MethodSetting-loggingLevel) resource in the *Amazon API Gateway API Reference* .
         *
...
export declare namespace CfnUsagePlan {
    ...
    interface QuotaSettingsProperty {
        ...
        /**
         * The time period for which the target maximum limit of requests applies, such as `DAY` or `WEEK` . For valid values, see the period property for the [UsagePlan](https://docs.aws.amazon.com/apigateway/latest/api/API_UsagePlan.html) resource in the *Amazon API Gateway REST API Reference* .
         *
